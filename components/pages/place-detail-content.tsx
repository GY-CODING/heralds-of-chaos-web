        ...
        >
          ...
          {worldName && place.world && (
            <motion.div
              ...
              className="p-6 bg-[var(--surface)] rounded-xl border border-[var(--border)] hover:border-[var(--gold)]/30 transition-colors"
            >
              ...
              >
                ...
                />
                <span className="text-lg font-bold text-[var(--gold)] group-hover:text-[var(--gold-light)] transition-colors">
                  {worldName}
                </span>
              </Link>
            </motion.div>
          ...
          >
            ...
            >
              ...
              {t.detail.backTo} {t.navigation.places}
            </Link>
          </motion.div>
        </motion.div>
      </div>
