...
import { Dog, ChevronLeft } from "lucide-react";
...
export function CreatureDetailContent({
  ...
  const otherLanguageName =
    language === "es" ? creature.name.en : creature.name.es;
        ...
        >
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-[var(--gold)]/10 border border-[var(--gold)]/30 rounded-xl">
                <Dog className="w-8 h-8 text-[var(--gold)]" />
              </div>
          ...
          >
            ...
            >
              ...
              {t.detail.backTo} {t.navigation.creatures}
            </Link>
          </motion.div>
        </motion.div>
      </div>
