...
export function CharacterDetailContent({
  ...
  return (
    <div className="min-h-screen py-8 sm:py-12 px-8 sm:px-8 lg:px-6 max-w-[1200px] mx-auto">
      {/* Breadcrumb */}
      <motion.nav
          ...
          <div>
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <div className="p-1.5 sm:p-2 bg-[var(--gold)]/10 border border-[var(--gold)]/30 rounded-lg sm:rounded-xl">
                <Crown className="w-6 h-6 sm:w-8 sm:h-8 text-[var(--gold)]" />
              </div>
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-bold text-[var(--gold)] mb-3 sm:mb-4">
              {currentTitle}
            </p>
